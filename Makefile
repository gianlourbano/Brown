...
# Things to build
ALL_FILES :=$(wildcard $(SRC_DIR)/**/**/**/*.cpp) $(wildcard $(SRC_DIR)/**/**/*.cpp) $(wildcard $(SRC_DIR)/**/*.cpp) $(wildcard $(SRC_DIR)/*.cpp)
ALL_HEADER_FILES :=$(wildcard $(SRC_DIR)/**/**/**/*.hpp) $(wildcard $(SRC_DIR)/**/**/*.hpp) $(wildcard $(SRC_DIR)/**/*.hpp) $(wildcard $(SRC_DIR)/*.hpp)
